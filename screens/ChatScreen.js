...
import { SafeAreaView, StatusBar,ScrollView , TextInput , TouchableWithoutFeedback, Keyboard} from 'react-native'
...
const ChatScreen = ({navigation, route}) => {
    ...
    return (
       ...
       <ScrollView contentContainerStyle={{paddingTop:15}}>
           {message.map(({id, data})=>
               data.email === auth.currentUser.email ?(
                  ...
                  rounded
                  size ={30}
                    source={{ uri : data.photoUrl ? data.photoUrl : "https://cencup.com/wp-content/uploads/2019/07/avatar-placeholder.png"}}
                  />
       ...
       placeholder="Raison Message" 
       style={styles.textInput}/>
       <TouchableOpacity onPress={sendMessage} activeOpacity={0.5}>
         <Ionicons name="send" send={34} color="#2B68E6"/>
       </TouchableOpacity>
       </View>
       </>
